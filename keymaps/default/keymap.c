...
LSFT_T(KC_LEFT_BRACKET), MT(MOD_RCTL, KC_Z), KC_X, MT(MOD_LALT, KC_C), LT(VIM,KC_V), KC_B,     KC_N, LT(VIM,KC_M), KC_COMM, KC_DOT, KC_SLSH, RSFT_T(KC_RIGHT_BRACKET),
    ...
    KC_SPC, KC_BACKSPACE, KC_MS_BTN1,       TD(TD_SLASH_MENU), OSL(NUMBERS),      OSM(MOD_RSFT),
...
KC_TRNS, KC_A, MT(MOD_LCTL, KC_R), MT(MOD_LGUI, KC_S), MT(MOD_LALT, KC_T), KC_D,    KC_H, MT(MOD_RALT, KC_N), MT(MOD_RGUI, KC_E), MT(MOD_RCTL, KC_I), KC_O, KC_TRNS,
KC_TRNS, MT(MOD_RCTL, KC_Z),    KC_X,    MT(MOD_LALT, KC_C),    LT(VIM, KC_V), KC_B,    KC_K,    LT(VIM, KC_M), KC_COMM, KC_DOT,  KC_SLSH,      KC_TRNS,
...
KC_TRNS, KC_TRNS, KC_TRNS,       KC_TRNS, KC_TRNS, KC_TRNS
  ...
  [SPECIAL] = LAYOUT(
    ...
    QK_BOOT,         KC_TRNS, KC_MS_WH_LEFT, KC_MS_UP,   KC_MS_WH_RIGHT, KC_TRNS,       KC_TRNS, KC_HOME, KC_UP,   KC_END, KC_TRNS,    QK_BOOT,
    KC_CAPS_LOCK,     KC_TRNS, KC_MS_LEFT,    KC_MS_DOWN, KC_MS_RIGHT,    KC_MS_WH_UP,   KC_PGUP,  KC_LEFT,    KC_DOWN, KC_RIGHT,    KC_TRNS,    KC_TRNS,
    KC_TRNS,        KC_TRNS, KC_MS_BTN2,     KC_MS_BTN3, KC_MS_BTN1,   KC_MS_WH_DOWN,     KC_PGDN,  OSM(MOD_RALT),   OSM(MOD_RGUI),   OSM(MOD_RCTL),          KC_TRNS,    QK_RBT,
