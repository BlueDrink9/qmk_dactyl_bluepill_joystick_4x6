...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [QWERTY] = LAYOUT(
QK_GRAVE_ESCAPE, KC_1, KC_2, KC_3, KC_4, LT(KC_5, SPECIAL),    KC_6, KC_7, KC_8, KC_9, KC_0, KC_EQL,
...
LSFT_T(KC_LEFT_BRACKET), KC_Z, KC_X, KC_C, LT(VIM,KC_V), KC_B,     KC_N, LT(VIM,KC_M), KC_COMM, KC_DOT, KC_SLSH, RSFT_T(KC_RIGHT_BRACKET),
    ...
    KC_SPC, MT(MOD_RALT, KC_ENTER), KC_MS_BTN1,       KC_APP,   TT(NUMBERS),      KC_RIGHT_SHIFT,
